...
exports.sendVerificationCodeMail = async (email, name, code) => {
    auth.setCredentials({
        refresh_token: MAIL_REFRESH_TOKEN,
    })
    try {
        ...
        const mailOptions = {
            from: SENDER_EMAIL_ACCOUNT,
            to: email,
            subject: "Reset iNeedSomething password",
            html: `
             <div style="
        max-width: 700px;
        padding-top: 2rem;
    ...
    ">
        ...
        ">
            <span style="
        padding: 1.5rem 0;
        ">You recently requested from iNeedSomething.org to reset your password. Please copy below code and type on "Code Verification" page input box.
            </span>
        </div>
